...
<qgis version="2.18.10" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="3" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="2" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="135,206,235,255"/>
  ...
  <aliases>
    ...
    <alias field="full_id" index="2" name=""/>
    <alias field="osm_id" index="3" name=""/>
    <alias field="osm_type" index="4" name=""/>
    <alias field="waterway" index="5" name=""/>
    <alias field="name" index="6" name=""/>
    <alias field="boat" index="7" name=""/>
    <alias field="layer" index="8" name=""/>
    <alias field="tunnel" index="9" name=""/>
    <alias field="width" index="10" name=""/>
    <alias field="surface" index="11" name=""/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="_uid_" expression=""/>
